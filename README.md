...
After you've written the SQL file, don't forget to run the SQL commands and create the db - in terminal, run:
...
Write one class per table. E.g., for the questions table we will write a Question class.
